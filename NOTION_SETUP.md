...
7. Retourne sur ta database, clique les `...` en haut à droite → "Connections" → ajoute "Veille IA Bot"

## 2. Créer le bucket Supabase

1. Crée un nouveau projet Supabase (ou utilise un existant)
2. Storage → New bucket → nom : `veille-ia-images` → **Public** : ON
...
Crée une adresse `veille-ia-tonnom@gmail.com` (ou utilise une existante dédiée).
Abonne-la à : TLDR AI, Ben's Bites, The Rundown AI, AI Tidbits.

### Activer l'API Gmail
1. Va sur https://console.cloud.google.com/
2. Crée un nouveau projet "Veille IA"
